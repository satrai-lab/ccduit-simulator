...
Transportation_data_types_ids = response.json()  # Contains information about Federation B and others (we could have a case that because of policy It cannot see anything other than functions of A)
